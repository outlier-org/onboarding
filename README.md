...
* Ready To Deploy: After an issue is finished and has been reviewed and approved by a teammate, it will moved to this column. After it has been deployed, it will be moved to the "Closed" column.
